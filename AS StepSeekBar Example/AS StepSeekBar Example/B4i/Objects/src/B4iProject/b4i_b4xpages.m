...
B4IRDebugUtils.currentLine=2424834;
 //BA.debugLineNum = 2424834;BA.debugLine="Return GetManager.FindPIFromB4XPage(B4XPage).Pare";
...
B4IRDebugUtils.currentLine=1572864;
 //BA.debugLineNum = 1572864;BA.debugLine="Sub Process_Globals";
B4IRDebugUtils.currentLine=1572865;
 //BA.debugLineNum = 1572865;BA.debugLine="Private mPM As Object";
self->__mpm = [NSObject new];
B4IRDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="Public Delegate As B4XPagesDelegator";
self->__delegate = [b4i_b4xpagesdelegator new];
B4IRDebugUtils.currentLine=1572867;
 //BA.debugLineNum = 1572867;BA.debugLine="Public GlobalContext As Object";
