...
public class b4i_asstepseekbar_subs_1 {
...
Debug.ShouldStop(536870912);
_thisindex = BA.numberCast(int.class, 0);Debug.locals.put("ThisIndex", _thisindex);Debug.locals.put("ThisIndex", _thisindex);
 BA.debugLineNum = 191;BA.debugLine="Dim ItemHeight As Float = (mBase.Height/lst_Y.S";
Debug.ShouldStop(1073741824);
_itemheight = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(false,"_lst_y" /*RemoteObject*/ ).runMethod(true,"Size")}, "/",0, 0)),__ref.getField(true,"_radius2" /*RemoteObject*/ )}, "+",1, 0));Debug.locals.put("ItemHeight", _itemheight);Debug.locals.put("ItemHeight", _itemheight);
