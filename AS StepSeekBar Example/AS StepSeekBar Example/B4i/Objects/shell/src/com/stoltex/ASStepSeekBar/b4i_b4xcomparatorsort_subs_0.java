...
public class b4i_b4xcomparatorsort_subs_0 {
...
try {
		Debug.PushSubsStack("Initialize (b4xcomparatorsort) ","b4xcomparatorsort",8,__ref.getField(false, "bi"),__ref,4);
...
try {
		Debug.PushSubsStack("Partition (b4xcomparatorsort) ","b4xcomparatorsort",8,__ref.getField(false, "bi"),__ref,30);
...
RemoteObject _pivotvalue = RemoteObject.declareNull("NSObject");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_swap::::" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_pivotindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)));
...
{
final int step4 = 1;
final int limit4 = RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(2)}, "-",1, 1).<Number>get().intValue();
_i = 0 ;
for (;(step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4) ;_i = ((int)(0 + _i + step4))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 35;BA.debugLine="If CallSub3(Comparator, \"Compare\", Data.Get(Star";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",(BA.numberCast(int.class, b4i_main.__c.runMethodAndSync(false,"CallSub3:::::",__ref.getField(false, "bi"),(Object)(_comparator),(Object)(BA.ObjectToString("Compare")),(Object)(_data.runMethod(false,"Get:",(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,RemoteObject.createImmutable(_i)}, "+",1, 1)))),(Object)(_pivotvalue)))),BA.numberCast(double.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_swap::::" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_l,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(BA.numberCast(int.class, _i)));
 };
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_swap::::" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(_l));
...
try {
		Debug.PushSubsStack("QuickSort (b4xcomparatorsort) ","b4xcomparatorsort",8,__ref.getField(false, "bi"),__ref,21);
...
Debug.JustUpdateDeviceLine();
_pivotindex = b4i_main.__c.runMethod(true,"Rnd::",(Object)(BA.numberCast(int.class, 0)),(Object)(_length));Debug.locals.put("PivotIndex", _pivotindex);Debug.locals.put("PivotIndex", _pivotindex);
 BA.debugLineNum = 24;BA.debugLine="Dim r As Int = Partition(Data, StartIndex, Lengt";
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (b4i_b4xcomparatorsort.class, "_partition:::::" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_length),(Object)(_pivotindex),(Object)(_comparator));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 25;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_quicksort::::" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_r),(Object)(_comparator));
 BA.debugLineNum = 26;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_quicksort::::" /*RemoteObject*/ ,(Object)(_data),(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,_r,RemoteObject.createImmutable(1)}, "++",2, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_length,_r,RemoteObject.createImmutable(1)}, "--",2, 1)),(Object)(_comparator));
 };
...
try {
		Debug.PushSubsStack("Sort (b4xcomparatorsort) ","b4xcomparatorsort",8,__ref.getField(false, "bi"),__ref,12);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcomparatorsort.class, "_quicksort::::" /*RemoteObject*/ ,(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(_data.runMethod(true,"Size")),(Object)(_comparator));
...
try {
		Debug.PushSubsStack("Swap (b4xcomparatorsort) ","b4xcomparatorsort",8,__ref.getField(false, "bi"),__ref,44);
