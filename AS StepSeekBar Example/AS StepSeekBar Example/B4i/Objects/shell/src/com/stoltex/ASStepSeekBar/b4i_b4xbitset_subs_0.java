...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,54);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 56;BA.debugLine="Dim data(4 * (Bit.ShiftRight(mSize, 5) + 1)) As B";
Debug.JustUpdateDeviceLine();
