...
public class b4i_b4xcache_subs_0 {
...
b4i_b4xcache._data = RemoteObject.createNew ("b4i_b4xorderedmap");__ref.setField("_data",b4i_b4xcache._data);
 //BA.debugLineNum = 4;BA.debugLine="Private mMaxSize As Int = 100";
b4i_b4xcache._mmaxsize = BA.numberCast(int.class, 100);__ref.setField("_mmaxsize",b4i_b4xcache._mmaxsize);
 //BA.debugLineNum = 5;BA.debugLine="Private RemoveThreshold As Float = 0.3";
b4i_b4xcache._removethreshold = BA.numberCast(float.class, 0.3);__ref.setField("_removethreshold",b4i_b4xcache._removethreshold);
 //BA.debugLineNum = 6;BA.debugLine="Private EternalCounts As Int";
b4i_b4xcache._eternalcounts = RemoteObject.createImmutable(0);__ref.setField("_eternalcounts",b4i_b4xcache._eternalcounts);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _containskey(RemoteObject __ref,RemoteObject _key) throws Exception{
try {
		Debug.PushSubsStack("ContainsKey (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,66);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_containskey:" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("CreateB4XCacheItem (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,102);
if (RapidSub.canDelegate("createb4xcacheitem")) { return __ref.runUserSub(false, "b4xcache","createb4xcacheitem", __ref, _value, _key);}
RemoteObject _t1 = RemoteObject.declareNull("_b4xcacheitem");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("_b4xcacheitem");Debug.locals.put("t1", _t1);
...
Debug.JustUpdateDeviceLine();
_t1.setField ("LastAccessedTime" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"));
...
try {
		Debug.PushSubsStack("Get (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,24);
if (RapidSub.canDelegate("get")) { return __ref.runUserSub(false, "b4xcache","get", __ref, _key);}
RemoteObject _ci = RemoteObject.declareNull("_b4xcacheitem");
Debug.locals.put("Key", _key);
...
Debug.JustUpdateDeviceLine();
_ci = (__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_get:" /*RemoteObject*/ ,(Object)((_key))));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_ci.getField(true,"Eternal" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False"))) { 
_ci.setField ("LastAccessedTime" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"));};
...
try {
		Debug.PushSubsStack("getMaxSize (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,19);
...
try {
		Debug.PushSubsStack("Initialize (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,9);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_initialize:" /*RemoteObject*/ ,__ref.getField(false, "bi"));
...
try {
		Debug.PushSubsStack("IsEternal (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,60);
...
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToBoolean(((RemoteObject.solveBoolean("n",_ci)) ? ((b4i_main.__c.runMethod(true,"False"))) : ((_ci.getField(true,"Eternal" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("Keys (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,98);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Put (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,35);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4i_b4xcache.class, "_iseternal:" /*RemoteObject*/ ,(Object)(_key)).getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_put::" /*RemoteObject*/ ,(Object)((_key)),(Object)((__ref.runClassMethod (b4i_b4xcache.class, "_createb4xcacheitem::" /*RemoteObject*/ ,(Object)(_value),(Object)(_key)))));
 BA.debugLineNum = 38;BA.debugLine="TrimIfOversize";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xcache.class, "_trimifoversize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("PutEternal (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,44);
...
Debug.JustUpdateDeviceLine();
_ci = __ref.runClassMethod (b4i_b4xcache.class, "_createb4xcacheitem::" /*RemoteObject*/ ,(Object)(_value),(Object)(_key));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
 BA.debugLineNum = 47;BA.debugLine="ci.Eternal = True";
Debug.JustUpdateDeviceLine();
_ci.setField ("Eternal" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"True"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_put::" /*RemoteObject*/ ,(Object)((_key)),(Object)((_ci)));
...
try {
		Debug.PushSubsStack("Remove (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,55);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_remove:" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("RemoveOldItems (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,82);
if (RapidSub.canDelegate("removeolditems")) { return __ref.runUserSub(false, "b4xcache","removeolditems", __ref, _agems);}
RemoteObject _values = RemoteObject.declareNull("B4IList");
...
Debug.JustUpdateDeviceLine();
_values = RemoteObject.createNew ("B4IList");
_values = __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );Debug.locals.put("values", _values);Debug.locals.put("values", _values);
 BA.debugLineNum = 84;BA.debugLine="Dim level As Long = DateTime.Now - AgeMs";
Debug.JustUpdateDeviceLine();
_level = RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"),_agems}, "-",1, 2);Debug.locals.put("level", _level);Debug.locals.put("level", _level);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_remove:" /*RemoteObject*/ ,(Object)((_ci.getField(true,"Key" /*RemoteObject*/ ))));
 };
 }
}Debug.locals.put("ci", _ci);
;
...
try {
		Debug.PushSubsStack("setMaxSize (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,14);
...
try {
		Debug.PushSubsStack("Size (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,93);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TrimIfOversize (b4xcache) ","b4xcache",6,__ref.getField(false, "bi"),__ref,70);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getsize" /*RemoteObject*/ ),__ref.getField(true,"_eternalcounts" /*RemoteObject*/ )}, "-",1, 1),BA.numberCast(double.class, __ref.getField(true,"_mmaxsize" /*RemoteObject*/ )))) { 
