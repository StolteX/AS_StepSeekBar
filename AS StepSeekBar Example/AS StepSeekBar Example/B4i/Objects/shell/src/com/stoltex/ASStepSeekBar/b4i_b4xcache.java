...
public class b4i_b4xcache {
    public static RemoteObject myClass;
	public b4i_b4xcache() {
	}
    public static PCBA staticBA = new PCBA(null, b4i_b4xcache.class);

public static RemoteObject __c = RemoteObject.declareNull("B4ICommon");
public static RemoteObject _data = RemoteObject.declareNull("b4i_b4xorderedmap");
public static RemoteObject _mmaxsize = RemoteObject.createImmutable(0);
public static RemoteObject _removethreshold = RemoteObject.createImmutable(0.0f);
