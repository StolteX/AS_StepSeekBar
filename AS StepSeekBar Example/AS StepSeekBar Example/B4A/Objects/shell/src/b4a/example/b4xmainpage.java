...
public static RemoteObject _asstepseekbar1 = RemoteObject.declareNull("b4a.example.asstepseekbar");
public static RemoteObject _asstepseekbar2 = RemoteObject.declareNull("b4a.example.asstepseekbar");
